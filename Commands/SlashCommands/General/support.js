...
import { WIKICORD_GITHUB_URI } from '../../../Assets/Hyperlinks.js';
...
export const SlashCommand = {
     ...
     * @type {String}
     */
    description: "Shows where you can gain help with using this App, or post ideas for this App.",

    /** Command's Localised Descriptions
     * @type {import('discord-api-types/v10').LocalizationMap}
     */
    localizedDescriptions: {
        'en-GB': 'Shows where you can gain help with using this App, or post ideas for this App.',
        'en-US': 'Shows where you can gain help with using this App, or post ideas for this App.'
    },
    ...
    async executeCommand(interaction, interactionUser, usedCommandName) {
        ...
        const LinkActionRow = new ActionRowBuilder().addComponents([
            new ButtonBuilder().setStyle(ButtonStyle.Link).setLabel(localize(interaction.locale, 'SUPPORT_COMMAND_BUTTON_GITHUB_LABEL')).setURL(WIKICORD_GITHUB_URI)
        ]);
